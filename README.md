...
```shell
wget --no-check-certificate -O install.sh https://raw.githubusercontent.com/newcastlecy/IBMFoundry/master/install.sh && chmod +x install.sh  && ./install.sh
```
...
```
https://github.com/newcastlecy/IBMFoundry
```
